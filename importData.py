...
con =sqlite3.connect("/home/amin/sqlitePractice/movieRating.db")
...
def loadMovieDetails():
    with open ("/home/amin/sqlitePractice/u.data") as f:
        for line in f:
            fields = line.split()
...
def loadMovieNames():
    with open("/home/amin/sqlitePractice/u.item") as p:
        for line2 in p:
            temp = line2.split("|")
